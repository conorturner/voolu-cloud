    ...
    constructor(props) {
        ...
        this.state = {
            ...
            navLinks: [
                ...
                {id: 2, title: "Get Started", link: "/get-started"},
                ...
                //     isOpenSubMenu: false,
                //     child: [
                //         {id: 1, title: "Get Started", link: "/get-started"},
                        ...
                        {(() => {
                            if (this.props.location.pathname === "/index-developer") {
                                        ...
                                        <li className="list-inline-item mb-0">
                                            ...
                                            >
                                                ...
                                                >
                                                    ...
                                                    {/*<a className="dropdown-item text-dark" download={true}*/}
                                                    {/*   href="/download/voolu">*/}
                                ...
                                return (
                                    <div className="buy-button">
                                        {/*<a*/}
                                        {/*    download={true} href="/download/voolu"*/}
                                        {/*    id="buyButton"*/}
